...
try {	
  ...
  $mail->Username   = "sajjadhosaini"; // نام کاربری SMTP
  $mail->Password   = "!&%)$))))";        // کلمه عبور SMTP
  $mail->AddReplyTo('sajjadhosaini@gmail.com', 'sajjadhosaini'); // افزودن پاسخ به ارسال کننده
  $mail->AddAddress('sajjadhosaini1@gmail.com', 'sajjadhosaini1'); // تنظیم آدرس گیرنده ایمیل
  $mail->SetFrom('sajjadhosaini@gmail.com', 'sajjadhosaini'); // تنظیم قسمت ارسال کننده ایمیل
